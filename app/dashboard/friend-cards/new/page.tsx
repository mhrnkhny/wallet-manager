...
export default function NewFriendCardPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">افزودن کارت دوست جدید</h1>
          <p className="text-gray-400 mt-1">ثبت اطلاعات کارت بانکی دوست</p>
        </div>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-300">
              اطلاعات کارت‌های دوستان به صورت امن ذخیره می‌شود و فقط برای شما قابل مشاهده است.
              این اطلاعات برای راحتی در انتقال وجه استفاده می‌شود.
            </p>
          </div>
        </div>
      </Card>
